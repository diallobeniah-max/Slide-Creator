...
const BUTTON_DEFS = {
    ...
    "btn-invert":         { title:"",                    variant:"invert", svg: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="invertGrad" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" style="stop-color:#FFFFFF;stop-opacity:1"/><stop offset="100%" style="stop-color:#000000;stop-opacity:1"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M 12 2 A 10 10 0 0 1 22 12 L 12 12 Z" fill="url(#invertGrad)"/><path d="M 12 12 L 22 12 A 10 10 0 0 1 12 22 Z" fill="url(#invertGrad)" opacity="0.5"/></svg>` }
};
